...
print("Welcome to excuse generator 1.1. Generating excuse...")
noun0 = (randint(0, 25))
verb0 = (randint(1, 9))
...
if verb0 == 1:
    ...
    verbcorrespondent0 = "go to " + pronoun + "soccer game"
elif verb0 == 4:
    verbcorrespondent0 = "destroy planet earth"
elif verb0 == 5:
    ...
    verbcorrespondent0 = "go to " +  pronoun + " martial arts lesson"
if adjective1 == 1:
    ...
    adjectivecorrespondent0 = "hungry"
elif adjective == 5:
    adjectivecorrespondent0 = "angry"
if gender == 1:
    pronoun = "his"
    pronoun2 = "he's"
elif gender == 2:
...
print("I would love to, but my "+ nouncorrespondent0 , "needs to "+ verbcorrespondent0+", because "+ pronoun2 + " " + adjectivecorrespondent0+".")
